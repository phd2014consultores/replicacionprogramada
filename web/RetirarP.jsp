...
<html>
	...
	<title>Retirar Replicador</title>
	<!-- Bootstrap -->
	<style type="text/css">
...
<body>  
    ...
    <div id="Bandejas" >
        ...
        <form name="eliminar" class="form-horizontal" method="POST" action="RetirarP">          
            ...
            <input type="hidden" onclick="retirar()" name="${_csrf.parameterName}" value="${_csrf.token}" />                
        </form>
        ...
        <c:if test="${mensaje2 == 'existe'}">
            <script language="JavaScript">
                {
                    alert("Este usuario no esta asignado a la tienda especificada..!!");
                }
            </script>   
        </c:if>
